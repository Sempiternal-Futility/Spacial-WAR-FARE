...
{ 
     ...
     if (curPOS == (enemyPOS, 2) || curPOS == (enemyPOS + 1, 2)) 
     {
     ...
     if (wakeTHREAD == false) {Thread.Sleep(1);} // THIS IS HERE TO INCREASE THE PERFORMANCE (however there's still cpu spikes) (this is what causes bug 2, but its necessary for the performance)
